...
// Source: D:\Programming\Go\url-shortner\cache-server\external\database-service\database_service.go
...
func (m *MockDatabaseServiceInterface) HandleRedirect(body io.Reader, requestId string) (string, error) {
	m.ctrl.T.Helper()
